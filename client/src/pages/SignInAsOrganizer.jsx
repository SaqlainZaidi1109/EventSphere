...
export default function SignInAsOrganizer() {
  ...
  const handleSubmit = async (e)=>{
    ...
    setErrorMessage(null)
      const res = await fetch('api/auth/signinOrganizer',{
        method:"POST",
 ...
 console.log(formData)
  return (
    ...
    <div className='h-96 md:w-2/4 sm:w-2/4  bg-gray-100 rounded-xl shadow-2xl my-20  lg:mr-5 md:mr-5  sm:mr-5'>
     <h1 className='font-Teachers text-center text-2xl p-5 shadow-md '>Organizer Sign-in</h1>
     <div className='flex justify-between ml-4 mr-6'>
     <h1 className='font-Teachers text-xl ml-2 p-3 '></h1>
