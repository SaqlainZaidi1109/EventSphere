...
export default function SignUpAsAttendee() {
  return (
    <>
     <div className='h-svh content-center'>
    <div className='flex  justify-center gap-4'>
    <img class="hidden sm:block lg:h-96 md:h-96 lg:my-20 md:my-20 transition-all duration-300 rounded-md cursor-pointer filter grayscale hover:grayscale-0" src="./src/assets/audience2.svg" alt="image description"/>
    <div className='h-96 md:w-2/4 sm:w-2/4  bg-gray-100 rounded-xl shadow-2xl my-20  lg:mr-5 md:mr-5  sm:mr-5'>
     <h1 className='font-Teachers text-center text-2xl p-5 shadow-md '>Attendee Sign-up</h1>
