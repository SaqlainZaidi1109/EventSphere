...
export default function SignUpAsOrganizer() {
  return (
    ...
    <img class="hidden sm:block lg:h-2/4 md:h-96 lg:my-0 md:my-20 transition-all duration-300 rounded-md cursor-pointer filter grayscale hover:grayscale-0" src="./src/assets/register.svg" alt="image description"/>
